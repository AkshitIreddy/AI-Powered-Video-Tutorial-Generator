...
BUILTIN_CATALOG = ModelCatalog(
    (
        ...
        ModelCatalogEntry(
            ...
            preferred_serialization=SerializationFormat.SAFETENSORS,
            resources=ResourceEstimate(24 * GIB, 12 * GIB, 12 * GIB, 4, True),
            supported_backends=frozenset({ComputeBackend.NVIDIA_CUDA}),
            ...
            notes=(
                ...
                "eight-second probe took 199 seconds, peaked at 8196 MiB device "
                "memory, and used about 11.87 GiB private process memory on an RTX "
                "4080 Laptop with 32 GiB RAM. The 12 GiB RAM estimate is rounded from "
                "that bounded 512 px profile, not a universal maximum. Preview new "
                "portraits; a completed inference is not a guarantee of visual quality."
            ),
        ),
        ModelCatalogEntry(
