...
export const stockAndReviewCloudCatalogItems: readonly CatalogItem[] = Object.freeze([
  ...
  adaptCloudEndpoint({
    ...
    credentialConfigured: false,
    reachable: null,
    description: "NVIDIA's current hosted image-and-text review route supported by Alystria's production adapter. Its catalog and request contract are verified; a live semantic review remains unproven after a transient HTTP 503 smoke response.",
