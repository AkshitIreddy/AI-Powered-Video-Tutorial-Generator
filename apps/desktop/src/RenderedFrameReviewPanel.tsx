...
export function RenderedFrameReviewPanel({ value, generationId, mediaHash }: { value: unknown; generationId?: string | undefined; mediaHash?: string | undefined }) {
  ...
  const reason = review.reason === "no_explicit_vlm_route" ? "No image-review provider was selected for this tutorial." : review.reason === "private_project" ? "This tutorial's privacy settings exclude cloud image review." : "An automated frame review is not available for this render.";
